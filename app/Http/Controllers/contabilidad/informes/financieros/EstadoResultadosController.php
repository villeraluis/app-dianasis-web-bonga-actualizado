...
class EstadoResultadosController extends Controller
{
    ...
    public function viewEstadoResultados()
    {
        cambioBaseDatos();
    ...
    public function infEstadoResultados(Request $request)
    {
    ...
    public function consultaEstadoResultados($request)
    {
        ...
        if ($radioBtn == 0) {
            ...
            $sql = "SELECT MovCuen,MovScue,MovAuxi,MovAuxl,Sum(MovValr)as MovValr 
                    ...
                    WHERE (TmoEmpr ='$empresa'  $vFiltro And TmoAno = '$year' And TmoMes <= '$mes' And TmoApl = '0' 
