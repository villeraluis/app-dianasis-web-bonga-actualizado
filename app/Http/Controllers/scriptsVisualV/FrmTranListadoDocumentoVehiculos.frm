...
Begin VB.Form FrmTranListadoDocumentoVehiculos 
   BackColor       =   &H00C0C0FF&
   ...
   ClientTop       =   330
   ClientWidth     =   11910
   Icon            =   "FrmTranListadoDocumentoVehiculos.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   720
      Width           =   8160
      Begin VB.ComboBox CobDocumentos 
         Height          =   315
         Left            =   1350
   ...
   Begin VB.Frame Frabusqueda 
      ...
      Begin VB.ComboBox CobCampos 
         Height          =   315
         ItemData        =   "FrmTranListadoDocumentoVehiculos.frx":46B2
         Left            =   1080
         List            =   "FrmTranListadoDocumentoVehiculos.frx":46B4
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   270
         Width           =   2445
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   375
         Left            =   7650
         Picture         =   "FrmTranListadoDocumentoVehiculos.frx":46B6
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   240
         Width           =   1350
   ...
   Begin VB.CommandButton Cmdplano 
      ...
      Height          =   375
      Left            =   8100
      Picture         =   "FrmTranListadoDocumentoVehiculos.frx":6188
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmTranListadoDocumentoVehiculos.frx":7C5A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmTranListadoDocumentoVehiculos.frx":819E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmTranListadoDocumentoVehiculos.frx":82AA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmTranListadoDocumentoVehiculos.frx":86FE
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label LblTitle 
      BackColor       =   &H00A8753C&
      Caption         =   "      Informe de Documentos Vehiculos"
      BeginProperty Font 
         Name            =   "Century Gothic"
         Size            =   12.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmTranListadoDocumentoVehiculos"
...
Private Sub BarraOperaciones_BuscarRegistro(Estado As BarraDiana.ResEstado)
        ...
        With FGvehiculos
            ...
            If DTfechaF.value < DTfechaI.value Then MsgBox "Seleccione bien el intervalo de Fechas", vbCritical + vbOKOnly, "Atención": Exit Sub
            vFiltro = Empty
            vFiltroTercero = Empty
            If CobDocumentos.Text <> Empty Then
                 Select Case CobDocumentos.Text
                        Case "TARJETA DE OPERACIÓN"
                             vFiltro = " AND VehDaFechaVenTarjeta BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "SEGURO OBLIGATORIO"
                             vFiltro = " AND VehDaFechaVenSeguro BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "CERTIFICADO DE REVISIÓN TECNICOMECANICA"
                             vFiltro = " AND VehDaFechaVenCertificadoTM BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "SEGURO CONTRACTUAL"
                             vFiltro = " AND VehDaFechaVenSeguroContratual BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "SEGURO TODO RIESGO"
                             vFiltro = " AND VehDaFechaVenSeguroTR BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "SEGURO EXTRACONTRACTUAL"
                             vFiltro = " AND VehDaFechaVenSeguroContratual BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                        Case "CERTIFICADO CDA/CEA BIMESTRAL"
                             vFiltro = " AND VehDaFechaVenCerTMBBimestral BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "'"
                 End Select
            Else
                 vFiltro = " AND ((VehDaFechaVenTarjeta BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenSeguro BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenCertificadoTM BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenSeguroContratual BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenSeguroTR BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenCerTMBBimestral BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "') OR " & _
                     "(VehDaFechaVenSegExtraCon BETWEEN '" & Format(DTfechaI.value, FormatoFecha) & "' AND '" & Format(DTfechaF.value, FormatoFecha) & "')) "
            End If
            ...
            Sql = "SELECT A.*,B.TmaStDescripcionUna AS Clase,C.TmaStDescripcionUna AS Combustible,D.TmaStDescripcionUna AS Linea,E.TmaStDescripcionUna AS Capacidad," & _
                  "F.TmaStDescripcionUna AS Nivel,G.TmaStDescripcionUna AS Marca,H.*,I.CliStNombreCliente,J.*,K.CliStNombreCliente AS Propietario " & _
                  ...
                  "LEFT OUTER JOIN TRANVEHICULOPROPIETARIOS J ON (A.VehIdStEmpresa = J.VpoIdStEmpresa AND A.VehIdStPlaca=J.VpoIdStPlacaVehiculo) " & _
            ...
            If Buscar_Res(rdoRs, Sql) = BDOk Then
                  While Not rdoRs.EOF
                        ...
                        If Z = "-1" Then
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenTarjeta) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenTarjeta
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenTarjetaOper, .Rows - 1, Datos.FecvenTarjetaOper) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenTarjetaOper, .Rows - 1, Datos.FecvenTarjetaOper) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenSeguro) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenSeguro
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                      .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenSegOblig, .Rows - 1, Datos.FecvenSegOblig) = vbRed
                                      .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenSegOblig, .Rows - 1, Datos.FecvenSegOblig) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenCertificadoTM) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenCertificadoTM
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenCerTm, .Rows - 1, Datos.FecvenCerTm) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenCerTm, .Rows - 1, Datos.FecvenCerTm) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenSeguroContratual) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenSeguroContratual
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenSegContratual, .Rows - 1, Datos.FecvenSegContratual) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenSegContratual, .Rows - 1, Datos.FecvenSegContratual) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenSegExtraCon) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenSegExtraCon
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenSegExtraContratual, .Rows - 1, Datos.FecvenSegExtraContratual) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenSegExtraContratual, .Rows - 1, Datos.FecvenSegExtraContratual) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VehDaFechaVenSeguroTR) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenSeguroTR
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenSegTodoRiesgo, .Rows - 1, Datos.FecvenSegTodoRiesgo) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenSegTodoRiesgo, .Rows - 1, Datos.FecvenSegTodoRiesgo) = vbWhite
                                 End If
                            End If
                            
                            .TextMatrix(.Rows - 1, Datos.CertificadoCDA) = Trim("" & rdoRs!VehStCertificadoTMBimestral) & " "
                            .TextMatrix(.Rows - 1, Datos.FecvenCertificadoCDA) = Format(Trim("" & rdoRs!VehDaFechaVenCerTMBBimestral), "dd-mm-yyyy")
                            .TextMatrix(.Rows - 1, Datos.ReqCertificadoCDA) = Val("" & rdoRs!VehSwReqCerTMBBimestral)
                            If Trim("" & rdoRs!VehDaFechaVenCerTMBBimestral) <> Empty Then
                                 vFecha = rdoRs!VehDaFechaVenCerTMBBimestral
                                 If vFecha >= Me.DTfechaI.value And vFecha <= Me.DTfechaF.value Then
                                     .Cell(flexcpBackColor, .Rows - 1, Datos.FecvenCertificadoCDA, .Rows - 1, Datos.FecvenCertificadoCDA) = vbRed
                                     .Cell(flexcpForeColor, .Rows - 1, Datos.FecvenCertificadoCDA, .Rows - 1, Datos.FecvenCertificadoCDA) = vbWhite
                                 End If
                            End If
                            ...
                            If Trim("" & rdoRs!VcdStPrincipal) = "1" Then .TextMatrix(.Rows - 1, Datos.NomConductor) = Trim("" & rdoRs!CliStNombreCliente)
                            If Trim("" & rdoRs!VpoStPrincipal) = "1" Then .TextMatrix(.Rows - 1, Datos.NomPropietario) = Trim("" & rdoRs!Propietario)
                            vVehiculos.Add .Rows - 1, V1
                            i = i + 1
                        Else
                            If Trim("" & rdoRs!VcdStPrincipal) = "1" Then .TextMatrix(Z, Datos.NomConductor) = Trim("" & rdoRs!CliStNombreCliente)
                            If Trim("" & rdoRs!VpoStPrincipal) = "1" Then .TextMatrix(Z, Datos.NomPropietario) = Trim("" & rdoRs!Propietario)
            ...
            Else
                MsgBox "No hay informaciòn para mostrar", vbInformation + vbOKOnly, "Atenciòn"
            End If
        ...
        End With
        Exit Sub
Salida: MsgBox "Consultar con el Adm. del Sistema", vbInformation + vbOKOnly, "Atenciòn"
...
Private Sub BarraOperaciones_ImprimirRegistro(ByVal Estado As BarraDiana.ResEstado)
        ...
        If Permisos(4) = "N" Then MsgBox "Opercaión no Autorizada ", vbCritical + vbOKOnly, "Atención": Exit Sub
        If FGvehiculos.Rows - 2 < 1 Then MsgBox "No hay información para exportar", vbInformation + vbOKOnly, "Atención": Exit Sub
        
        If vRutaInfXls = Empty Then MsgBox "Señor usuario definir la ruta de informes en excel", vbInformation + vbOKOnly, "Atención": Exit Sub
        If Dir(vRutaInfXls, vbDirectory) = Empty Then MsgBox "Señor usuario la ruta configurada de informes en excel no existe", vbInformation + vbOKOnly, "Atención": Exit Sub
        
        If Me.FGvehiculos.Rows > 2 Then
           vNombreReporte = "LISTADO DE DOCUMENTOS DE VEHICULOS.XLS"
           FGvehiculos.SaveGrid vRutaInfXls & vNombreReporte, flexFileExcel, 3
           Call Abrir_LibroExcel(vRutaInfXls & vNombreReporte)
                      
           
           Exit Sub
           If MsgBox("Señor usuario el proceso de exportar archivo" & Chr(13) & "puede tardar unos minutos. ¿Desea continuar?.", vbYesNo + vbQuestion, "Atención") = vbNo Then Exit Sub
           With FGvehiculos
                FGexportar.Cols = 50
                FGexportar.Rows = 0
                ...
                With FGexportar
                     ...
                     .TextMatrix(.Rows - 1, Cont) = "Descripción": Cont = Cont + 1
...
'                Screen.MousePointer = vbDefault
           ...
           End With
        Else
            MsgBox "No hay información para exportar", vbInformation + vbOKOnly, "Atención"
        End If
        Exit Sub
...
Private Sub CmdBuscar_Click()
        If FGvehiculos.Rows < 3 Then MsgBox "No hay información para buscar", vbExclamation + vbOKOnly, "Atención": Exit Sub
...
Private Sub Cmdplano_Click()
        On Error GoTo Salida
        If FGvehiculos.Rows - 1 < 1 Then MsgBox "No hay información para exportar", vbInformation + vbOKOnly, "Atención": Exit Sub
        ComArchivo.CancelError = False
        ...
        Exit Sub
Salida: MsgBox "Consultar con el Adm. del Sistema", vbCritical + vbOKOnly, "Atención"
End Sub
...
Private Sub CobDocumentos_Click()
        FGConductores.Rows = 1: FGPropietarios.Rows = 1: FGvehiculos.Rows = 2
End Sub
...
Private Sub Form_Load()
        ...
        Mes = Month(FechaServidor) + 1
        Ax = Year(FechaServidor)
        If Mes > 12 Then Ax = Ax + 1: Mes = 1
        Ax = Trim(Str(Ax)): Mes = Trim(Str(Mes))
        vFecha = (Ax & "-" & Format(Mes, "00") & "-01")
        N = Val(Mid(Format(DateAdd("d", -1, vFecha), vFormatoFechaDiana), 1, 2))
        vFecha = Year(FechaServidor) & "-" & Format(Month(FechaServidor), "00") & "-" & Format(N, "00")
        Me.DTfechaF.value = vFecha
        vFecha = Year(FechaServidor) & "-" & Format(Month(FechaServidor), "00") & "-01"
        DTfechaI.value = vFecha
        CobDocumentos.AddItem ""
        CobDocumentos.AddItem "TARJETA DE OPERACIÓN"
        CobDocumentos.AddItem "SEGURO OBLIGATORIO"
        CobDocumentos.AddItem "CERTIFICADO DE REVISIÓN TECNICOMECANICA"
        CobDocumentos.AddItem "SEGURO CONTRACTUAL"
        CobDocumentos.AddItem "SEGURO EXTRACONTRACTUAL"
        CobDocumentos.AddItem "SEGURO TODO RIESGO"
        CobDocumentos.AddItem "CERTIFICADO CDA/CEA BIMESTRAL"
...
Private Sub DGRILLA()
    ...
    With FGvehiculos
          ...
          .ColDataType(Datos.ReqCertificadoCDA) = flexDTBoolean
          ...
          .TextMatrix(0, Datos.FondoReposicion) = "Valor": .TextMatrix(1, Datos.FondoReposicion) = "Fondo Reposiciòn"
          ...
          .TextMatrix(0, Datos.CertificadoCDA) = "Certificado": .TextMatrix(1, Datos.CertificadoCDA) = "CDA/CEA BIMESTRAL"
          .TextMatrix(0, Datos.FecvenCertificadoCDA) = "Fecha Vencimiento": .TextMatrix(1, Datos.FecvenCertificadoCDA) = "CDA/CEA BIMESTRAL"
          .TextMatrix(0, Datos.ReqCertificadoCDA) = "Requerido": .TextMatrix(1, Datos.ReqCertificadoCDA) = "CDA/CEA BIMESTRAL"
          ...
          .ColDataType(Datos.FecvenSegOblig) = flexDTStringC
          .ColDataType(Datos.FecvenCertificadoCDA) = flexDTStringC
     ...
     With Me.FGConductores
             ...
             .SelectionMode = flexSelectionByRow
             .Editable = flexEDNone
             .TextMatrix(0, Conductor.Cedula) = "Identificación"
        ...
        With FGPropietarios
             ...
             .SelectionMode = flexSelectionByRow
             .Editable = flexEDNone
             .TextMatrix(0, Propietario.Cedula) = "Identificación"
...
Private Sub PlaCentroCosto_BusquedaCodigo(Estado As DianaPlantilla.ResEstado)
        If PlaCentroCosto.Text <> Empty Then
             ...
             If Buscar_Res(rdoRs, Sql) = BDOk Then
                ...
                Else
                    MsgBox "Señor usuario debe seleccionar un centro de costo de movimientos", vbInformation + vbOKOnly, "Atencion"
                    vValidarCentro = True
                    Estado = EstCancel
                End If
             Else
                  MsgBox "El codigo digitado no existe", vbInformation + vbOKOnly, "Atención"
                  Estado = EstCancel
             End If
        End If
End Sub
