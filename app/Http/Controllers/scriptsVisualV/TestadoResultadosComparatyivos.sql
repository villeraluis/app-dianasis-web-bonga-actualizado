SELECT * FROM CARTILLA WHERE CarEmpr = '01' And CarCuen Like '41%' And Carcuen <> '4100'  And Carcuen <> '4175' ORDER BY CarCuen,CarScue,CarAuxi,CarAuxl

SELECT * FROM PARAMEPYG
