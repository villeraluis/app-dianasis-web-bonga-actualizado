<div>
    ...
    <div>
        <div class="table-responsive my-2 div-tabla div-tabla-scroll-y">
            ...
            <table class="table mt-4   table-hover table-sm tablaInformesCustom tablaInformesExport tabla-head-fijo"
                id="tablaAnalisctaEdades" style="width: 100%">

                <thead>
                    <tr>
                        <th scope="col" class="text-left" style="width: 3%">Cedula</th>
                        <th scope="col" class="text-left" style="width: 3%">Nombre </th>
                        ...
                        <th scope="col" class="text-center" style="width: 4%">Cartera</th>
                        ...
                        <th scope="col" class="pr-2 text-end" style="width: 7%">De 181 a 360</th>
                    ...
                    @foreach ($datos as $dato)
                        ...
                        @if ($dato['type'] == 'p-2')
                            ...
                            <tr class="tr-totales">
                                ...
                                <td>{{ $dato['cedula'] }}</td>
                                <td>{{ $dato['nombreCli'] }}</td>
                                <td>{{ $dato['sucursal'] }}</td>
                                <td>{{ $dato['concepto'] }}</td>
                                <td>{{ $dato['fecha'] }}</td>
                                <td>{{ $dato['cantDias'] }}</td>
                                <td>{{ $dato['fvence'] }}</td>
                                <td class="pr-2 text-end">{{ $dato['cartera'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'h')
                            ...
                            <tr class="movi {{ $dato['cedula'] }}">
                                ...
                                <td>{{ $dato['cedula'] }}</td>
                                <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{ $dato['factura'] }}</td>
                                <td>{{ $dato['sucursal'] }}</td>
                                <td>{{ $dato['concepto'] }}</td>
                                <td>{{ $dato['fecha'] }}</td>
