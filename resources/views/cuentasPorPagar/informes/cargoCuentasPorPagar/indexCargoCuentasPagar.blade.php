<div class=" p-1">
    <section class="row divSection1 mb-2">
        ...
        <div class="col-12 mb-2 header-informe">
            <b>Cargo Cuentas Por Pagar - {{ session('empresaNombre') }}</b>
        </div>

        <div class="col-12 contenedor-card">

            <div class="item-1-cont " style="max-width:960px;">
...
<script>
    $(document).ready(function() {
        ...
        $('#formConsultaInformes').on('submit', function(e) {
            ...
            const _url = route('consulta.cuentasPagar.informes.cargoCuentasPagar');
