<div class="border p-2">
    <section class="row divSection1">
        ...
        <div class="col-12 mb-2 header-informe">
            <b>Devoluciones en Compra Por Periodos - {{ session('empresaNombre') }}</b>
        </div>
...
<script>
    ...
    $('.imagenBotonHoy').prop('src', "{{ asset('vendor/img/devolucion_compra.png') }}");
    $('.tituloBtnBusquedaMes').text('Consultar Devoluciones Este Mes');
    ...
    $('#formConsultaInformes').on('submit', function(e) {
        ...
        let _url = route('consulta.informe.devoluciones.compras');
