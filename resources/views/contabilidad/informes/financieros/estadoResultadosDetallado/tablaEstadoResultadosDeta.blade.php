...
<div >
    ...
    <div class="border  mt-1 div-fondo-tabla">
        <div class="table-responsive  div-tabla-scroll-y "  style="max-width: 600px" >
            <table class="table mt-4 table-bordered  table-hover table-sm tablaInformesCustom tablaInformesExport tabla-head-fijo tabla-cols-fija" id="tablaEstadoResultados"
            >
                ...
                <tbody>
                    ...
                    @foreach ($datos as $dato)
                        @if ($dato['type'] == 'vacio')
                            ...
                            <tr class="vacio -00-00">
                                <td>{{ $dato['cuenta'] }}</td>
                                <td class="text-center">{{ $dato['subc'] }}</td>
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start"> <a href="#"><span class="border">&nbsp&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'p1')
                            ...
                            <tr class="pad {{ $dato['cuenta'] }}-00-00-00" role="button">
                                ...
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start"> <a href="#">&nbsp<span
                        ...
                        @elseif ($dato['type'] == 'p2')
                            ...
                            <tr
                                class="pad-1 {{ $dato['cuenta'] . '-' . $dato['subc'] . '-' . $dato['aux'] . '-' . $dato['aux1'] }} ">
                                <td>{{ $dato['cuenta'] }}</td>
                                <td class="text-center">{{ $dato['subc'] }}</td>
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start"> <a href="#">&nbsp&nbsp<span
                                            class="border">&nbsp+&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'p3')
                            ...
                            <tr
                                class="pad-2 {{ $dato['cuenta'] . '-' . $dato['subc'] . '-' . $dato['aux'] . '-' . $dato['aux1'] }}">
                                <td>{{ $dato['cuenta'] }}</td>
                                <td class="text-center">{{ $dato['subc'] }}</td>
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start"> <a href="#">&nbsp&nbsp&nbsp<span
                                            class="border">&nbsp+&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'p4')
                            ...
                            <tr
                                class="pad-3 {{ $dato['cuenta'] . '-' . $dato['subc'] . '-' . $dato['aux'] . '-' . $dato['aux1'] }}">
                                <td>{{ $dato['cuenta'] }}</td>
                                <td class="text-center">{{ $dato['subc'] }}</td>
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start"> &nbsp&nbsp&nbsp&nbsp<a href="#"><span
                                            class="border">&nbsp+&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'p5')
                            ...
                            <tr class="pad5">
                                ...
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start">&nbsp&nbsp&nbsp&nbsp&nbsp <a href="#"><span
                                            class="border">&nbsp+&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
                        ...
                        @elseif ($dato['type'] == 'h')
                            ...
                            <tr
                                class="movi {{ $dato['cuenta'] . '-' . $dato['subc'] . '-' . $dato['aux'] . '-' . $dato['aux1'] }}">
                                <td>{{ $dato['cuenta'] }}</td>
                                <td class="text-center">{{ $dato['subc'] }}</td>
                                <td class="text-center">{{ $dato['aux'] }}</td>
                                <td class="text-center">{{ $dato['aux1'] }}</td>
                                <td class="text-start">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href="#"><span
                                            class="border">&nbsp-&nbsp</span></a>
                                    {{ $dato['descripcion'] }}</td>
                                <td class=" pr-2 text-end">{{ $dato['valor'] }}</td>
...
<script>
    ...
    $('#tablaEstadoResultados>tbody>tr td:nth-child(5)>a').on('click', function(e) {
